...
public class FetchAddressIntentServices extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        if (intent != null) {
            ...
            if (addresses == null || addresses.isEmpty()) {
                deliverResultToReceived(Constants.FAILURE_RESULT, errorMessage);
            } else {
                ...
                deliverResultToReceived(Constants.SUCCESS_RESULT,
    ...
    private void deliverResultToReceived(int resultCode, String addressMessage) {
